...
(
    `comment_code`    INTEGER NOT NULL COMMENT '댓글코드',
...
CREATE TABLE `Notice`
(
    `Notice_code`    INTEGER NOT NULL COMMENT '게시물코드',
...
CREATE TABLE `praise`
(
    `praise_code`    INTEGER NOT NULL COMMENT '칭찬코드',
...
(
    `propose_code`    INTEGER NOT NULL COMMENT '건의사항코드',
...
(
    `Schedule_code`    INTEGER NOT NULL COMMENT '일정코드',
...
CREATE TABLE `Seat`
(
    `Seat_code`    INTEGER NOT NULL COMMENT '좌석코드',
    `student_code`    INTEGER NOT NULL COMMENT '학생코드',
